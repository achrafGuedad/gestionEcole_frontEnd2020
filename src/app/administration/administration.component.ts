...
export class AdministrationComponent implements OnInit {
  ...
  constructor(private adminService: AdministrationService,private router:Router,public dialog: MatDialog) {
  }
  ...
  loadPage(page:number){
   ...
   updateUser(idUser) {
    ...
    this.adminService.getUserById(idUser).subscribe(
     (data) =>{
       this.user=new User();
       this.user=data;
       console.log(this.user);
      let dialogRef = this.dialog.open(ModalUpdateUserComponent, {
